...
Pour commencer par la bonne nouvelle, la 🎉 https://github.com/jtama/project-graph-generator/releases/tag/v1.0.7[*V1.0.7*] 🐲 est disponible et contient aussi la recette permettant de compter le nombre d'invocations de chacune de vos méthodes publiques.
