...
Vous avez tout: les widgets, l'approche déclarative, le styling _css_.
...
Bon design de TamboUI : son widget `TreeElement<T>` sépare franchement les données de leur représentation. D'un côté, un `record` qui ne connaît rien à l'affichage :
