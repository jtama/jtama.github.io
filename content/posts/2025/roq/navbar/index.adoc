= ROQ - Changing the menu layout.
include::../../../../../includes/attributes-fr.adoc[]
:description: "How-to change the menu layout of your Roq powered blog"
:page-date: 2025-05-19
:page-key: roq-changing-the-menu-layout
:page-image: Panopticon.webp
:page-tags: roq,theme,layout,*-as-code,HowTos
:page-series: ROQ
:qute:
...
[.center]
image:previous.webp[Before,align="center"] -> image:after.webp[After,align="center"]
