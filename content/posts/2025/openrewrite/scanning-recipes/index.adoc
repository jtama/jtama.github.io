...
:page-image: panoramic-dental-xray.webp
:page-author: jtama
:page-date: 2025-10-19
:page-key: technique-avancee-dopenrewrite-orchestrer-des-refactorings-complexes-avec-les-scanningrecipe
:icon-set:far
...
Nous avons déjà vu dans les articles précédents pas mal d'exemples. Mais chacun d'eux concerne peuvent-être traités en ne prenant en compte qu'un fichier source, une _compilation unit_ en bon _Openrewrite_. Alors qu'allons-nous devenir si notre besoin dépasse les frontières d'un seul fichier ?
