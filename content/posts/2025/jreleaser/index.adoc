...
== Pre-requisite (tools and credentials)
...
Please correct you descriptor accordingly and repeat the opertation until everything is clean
...
On more thing, please. I prefere to only do dry run execution locally but that cannot be specified through file at the moment, so I export the value just before running the commands :
...
But at least do you know how to publish your artefacts to Maven Central \o/.