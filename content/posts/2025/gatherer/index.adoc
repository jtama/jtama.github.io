...
:page-tags: java,gatherer,preview
:page-image: photo-1530210124550-912dc1381cb8.webp
:page-author: jtama
:page-date: 2025-03-20
:page-key: to-gather-or-not-to-gather-that-is-the-question
:toc:
...
image::quizz.webp[Shakespeare posant une question]
...
Et là :
image::crumble.gif[C'est le drame]
...
image::fusion.webp[Illustration du résultat souhaité]
...
image::restez-curieux.webp[Rester curieux]
