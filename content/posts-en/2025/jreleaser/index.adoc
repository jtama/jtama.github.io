...
image:https://jreleaser.org/guide/latest/concepts/_images/jreleaser-workflow.avif[JReleaser workflow, link=https://jreleaser.org/guide/latest/concepts/workflow.html,window=_blank]
...
image::sonatype_token.avif[The name of the token is JReleaser]
